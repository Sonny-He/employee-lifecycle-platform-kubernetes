...
def get_ad_service_credentials():
    ...
    if _ad_service_creds is None:
        try:
            ...
            print(f"Could not retrieve service credentials: {e}")
            print(f"Falling back to default Admin account")
...
def ensure_ou_structure():
    ...
    print("Ensuring AD OU structure...")
    
    conn = get_ad_connection()
    if not conn:
        print("Cannot verify OU structure - no AD connection")
        return False
    ...
    for ou in ous:
        try:
            ...
            print(f"OU check/create error for {ou['dn']}: {e}")
...
def ensure_security_groups():
    ...
    for group in groups:
        try:
            ...
            print(f"Group error for {group['name']}: {e}")
...
if __name__ == '__main__':
    ...
    try:
        ...
        print(f"Could not initialize AD structure: {e}")
        print(f"Continuing without automated AD setup")
